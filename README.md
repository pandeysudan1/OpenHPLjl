...
## Reports 11-57 - one report per model family

Every entry in the literature model-family catalogue now has:

- a Julia source file in its physical-domain folder;
- a matching concise LaTeX report under `docs/model_reports/`;
- a matching PDF generated by CI.
